...
const DetailBox = () => {
    ...
    const {title, redate, likeNum, likeExisting, countView, tags, type, language, level, context, replyNum, replies} = postInfo;
            ...
            <S.DetailBoxSection>
                ...
                <S.DetailBoxLikesRepliesContainer>
                    ...
                    <S.DetailBoxRepliesContainer>
                        ...
                        {
                        replies && (
                        <Reply replies={replies} postId={postId} requestDetailBox={requestDetailBox}/>
                        )
                        }
                    </S.DetailBoxRepliesContainer>
                </S.DetailBoxLikesRepliesContainer>
